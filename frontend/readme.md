...
The current look is fine, but it could use a good header, and some front-end frameworks like React to clean up the look, make it more cohesive and modern.
...
node server.js
```
Server will begin running on local host, port 8080. Head to http://localhost:8080/ to experience the game!
